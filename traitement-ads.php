...
try {
    ...
    $mail->setFrom('contact@webprime.fr', 'Renovation Toiture');
    $mail->addAddress('conceptsfacades@gmail.com');
    ...
    header('Location: https://couvreur-11-aude.com/mercijfjsklqsf.html');
    exit();
} catch (Exception $e) {
